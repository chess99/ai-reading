...
- 优先直接写出书在讨论的**问题、判断、因果、冲突和后果**，少用“很具体、很明确、很重要、核心是、真正、最值得”等元评价替读者先下判断。能展示内容时，不要只评价内容。
- 上述词语**不是禁词**。当“核心”“关键”“真正”确实区分层级、限定含义或构成必要对照时可以保留；`不是 A，而是 B` 也只在 A 确实是常见误解、B 确实改变理解时使用。
- 文风审查遵循**只改明显问题**的原则：不要为了统一口吻、降低某个词频或追求“去 AI 味”而机械改写本来通顺、准确的句子。可改可不改、收益不明显的地方保持原样。
